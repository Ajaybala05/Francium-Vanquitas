...
import img1 from "../../assets/testimonal/1.jpg";
import img2 from "../../assets/testimonal/2.jpg";
import img3 from "../../assets/testimonal/3.jpg";

const testimonialData = [
  {
    id: 1,
    name: "David Calathan - Director of Design Operations, New York",
    text: "The insights I gained from this platform have completely transformed my trading strategy. I feel more confident making decisions! I was struggling with risk management until I found this service. Their guidance has been invaluable",
    img: img1,
  },
  {
    id: 1,
